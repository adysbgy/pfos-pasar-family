...
export default function Page() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-6 text-center">
      ...
      <h1 className="text-xl font-bold text-gray-900 mb-1">📋 Tugas Harian</h1>
      <p className="text-sm text-gray-500 mb-1">Checklist & Tugas</p>
      <p className="text-xs text-gray-400">Diakses oleh: Semua Staff</p>
